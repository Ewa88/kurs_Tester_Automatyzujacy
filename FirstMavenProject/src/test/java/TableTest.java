...
public class TableTest extends BaseTest{
    ...
    public void shouldDisplayMountainsAbove4000m(){
        List<String> mountainsAbove4000m = List.of("Mont Blanc", "Dufourspitze", "Dom", "Weisshorn", "Matterhorn","Finsteaarhorn", "Jungfrau", "Les Ecrins", "Gran Paradiso" );
        List<WebElement> mountainsOnPage = driver.findElements(By.cssSelector("tbody>tr"));
        ...
        for (Mountain mountain:mountains) {
            if(mountain.getHeight()>4000){
                System.out.println(mountain.getPeak());
                Assert.assertEquals(mountain.getPeak(),mountainsAbove4000m.get(i));
                i++;
            }
    ...
    @Test
    public void shouldDisplayMountainsAbove4000m2() {
    ...
    @Test
    public void shouldDisplayMountainsNotFromAlps() {
        List<String> mountainsNotAlps = List.of("Eiger", "Mulhacen");
        List<WebElement> mountainsOnPage = driver.findElements(By.cssSelector("tbody>tr"));
        List<Mountain> mountains = new ArrayList<>();
        ...
        for (Mountain mountain : mountains) {
            if (!mountain.getMountainRange().equals("Alps")) {
                Assert.assertTrue(mountainsNotAlps.contains(mountain.getPeak()));
                System.out.println(mountain.getPeak());
            }
        }
    }
